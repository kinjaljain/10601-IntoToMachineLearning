...
def main():
    ...
    theta = train_logistic_regression(X_train, Y_train, X_validation, Y_validation, theta, epochs)
...
def train_logistic_regression(X_train, Y_train, X_validation, Y_validation, theta, epochs):
    for i in range(epochs):
        for j in range(len(X_train)):
            theta = update_theta_step_sgd(theta, X_train, Y_train, j)
        train_loss = calculate_loss_function(theta, X_train, Y_train)
        # validation_loss = calculate_loss_function(theta, X_validation, Y_validation)
        print("Train loss after epoch {}: {}\n".format(i, train_loss))
        # print("Validation loss after epoch {}: {}\n".format(i, validation_loss))
    return theta
